...
/**
 * Combines UnorderedListADT and IndexedListADT interfaces and adds requirement
 * that the list supports a java.util.ListIterator.
 * 
 * @author Java Foundations
 * @version 4.0
 * @author mvail
 */
public interface DoubleLinkedListADT<T> extends UnorderedListADT<T>,
		IndexedListADT<T> {
	/**
