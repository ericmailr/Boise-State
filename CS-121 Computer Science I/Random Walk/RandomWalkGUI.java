...
public class RandomWalkGUI {
	 ...
	 * 
	 * @param walker
	 *            the RandomWalk object used for creating the walk
	 * @param gridSize
	 *            the size of the grid
	 */
	...
	/**
	 * Get input using the command line arguments and create and disolay the
	 * walk.
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			System.err
					.println("Usage: java RandomWalkGUI <gridSize> [<random seed>]");
			System.exit(1);
		}
